...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado geometrico | Paola Azuara", nullptr, nullptr);
	...
	float vertices[] = {
		...
		-0.5f, -0.5f, 0.5f, 0.1f, 0.7f,0.3f,//Front
		...
		-0.5f, -0.5f,-0.5f, 0.1f, 0.7f,0.3f,//Back
		 0.5f, -0.5f,-0.5f, 0.1f, 0.7f,0.3f,
		 0.5f,  0.5f,-0.5f, 0.1f, 0.7f,0.3f,
		 0.5f,  0.5f,-0.5f, 0.1f, 0.7f,0.3f,
		-0.5f,  0.5f,-0.5f, 0.1f, 0.7f,0.3f,
		...
		//CafeOscuro
		-0.5f, -0.5f, 0.5f, 1.0f, 0.54f,0.33f,//Front
		0.5f, -0.5f, 0.5f,  1.0f, 0.54f,0.33f,
		0.5f,  0.5f, 0.5f,  1.0f, 0.54f,0.33f,
		0.5f,  0.5f, 0.5f,  1.0f, 0.54f,0.33f,
		-0.5f,  0.5f, 0.5f, 1.0f, 0.54f,0.33f,
		-0.5f, -0.5f, 0.5f, 1.0f, 0.54f,0.33f,

		-0.5f, -0.5f,-0.5f, 1.0f, 0.54f,0.33f,//Back
		 0.5f, -0.5f,-0.5f, 1.0f, 0.54f,0.33f,
		 0.5f,  0.5f,-0.5f, 1.0f, 0.54f,0.33f,
		 0.5f,  0.5f,-0.5f, 1.0f, 0.54f,0.33f,
		-0.5f,  0.5f,-0.5f, 1.0f, 0.54f,0.33f,
		...
		//CafeClaro
		-0.5f, -0.5f, 0.5f, 0.75f, 0.54f, 0.33f,//Front
		 0.5f, -0.5f, 0.5f, 0.75f, 0.54f, 0.33f,
		 0.5f, 0.5f, 0.5f, 0.75f, 0.54f, 0.33f,
		 0.5f, 0.5f, 0.5f, 0.75f, 0.54f, 0.33f,
		-0.5f, 0.5f, 0.5f, 0.75f, 0.54f, 0.33f,
		-0.5f, -0.5f, 0.5f, 0.75f, 0.54f, 0.33f,

		-0.5f, -0.5f, -0.5f, 0.75f, 0.54f, 0.33f,//Back
		 0.5f, -0.5f, -0.5f, 0.75f, 0.54f, 0.33f,
		 0.5f, 0.5f, -0.5f, 0.75f, 0.54f, 0.33f,
		 0.5f, 0.5f, -0.5f, 0.75f, 0.54f, 0.33f,
	    -0.5f, 0.5f, -0.5f, 0.75f, 0.54f, 0.33f,
		...
		-0.5f, -0.5f, -0.5f, 1.0f, 0.5f, 0.03f,//Back
		0.5f, -0.5f, -0.5f,  1.0f, 0.5f, 0.0f,
		0.5f, 0.5f, -0.5f,   1.0f, 0.5f, 0.0f,
		0.5f, 0.5f, -0.5f,   1.0f, 0.5f, 0.0f,
		-0.5f, 0.5f, -0.5f,  1.0f, 0.5f, 0.0f,
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Cuello 
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(1.01f, 0.1f, 1.01f));
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 108, 144);//105-141

		//ALa1
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(1.6f, 0.4f, 0.4f));
		model = glm::translate(model, glm::vec3(0.0f, 0.1f, -0.1f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 108, 144);//105-141
		...
		//Cuerpo2
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(1.0f, 0.4f, 1.2f));
		model = glm::translate(model, glm::vec3(0.0f, -0.8f, -0.1f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 72, 108);//72-105
		...
		model = glm::translate(model, glm::vec3(0.7f, -10.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 144, 180);
		...
		//Ojo1
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(1.3f, 0.3f, 0.3f));
		model = glm::translate(model, glm::vec3(0.0f,3.5f, 0.2f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(0.0f, 10.5f, 0.2f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
